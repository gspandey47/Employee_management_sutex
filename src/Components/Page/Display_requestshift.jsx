...
const DisplayShiftRequest = () => {
  const [requests, setRequests] = useState([]);
  const navigate = useNavigate();
  useEffect(() => {
    axios.get("http://localhost/my-backend/desplayShift_request.php")
      .then(response => {
  ...
  return (
    <div className="container mx-auto p-6 bg-gray-100">
      <h2 className="text-3xl font-bold text-center text-blue-600 mb-4">Shift Change Requests</h2>
...
export default DisplayShiftRequest;
