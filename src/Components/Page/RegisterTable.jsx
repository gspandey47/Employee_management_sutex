...
const RegisterTable = () => {
    ...
    useEffect(() => {
        axios.get("http://localhost/my-backend/fetch_register.php") // Adjust path if needed
    ...
    const handleDelete = (id) => {
        if (window.confirm("Are you sure you want to delete this user?")) {
            axios.post("http://localhost/my-backend/delete_register.php", { id }) // Backend API for deletion
                .then(() => {
