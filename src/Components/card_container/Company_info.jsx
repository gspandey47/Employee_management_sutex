...
<>
<div className="max-w-2xl bg-gradient-to-r from-purple-500 to-purple-800 text-white rounded-xl shadow-lg pr-2 pl-2 lg:mx-3 lg:p-12 flex flex-row lg:flex-col">
      {/* Header Section */}
      <div className="flex flex-row-reverse lg:py-0 lg:flex-row ">
        {/* Logo Section */}
